...
public class BookPageTask implements Tasklet {
  ...
  public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext)
    ...
    do {
      ...
      try {
        boolean result = handle(bookEntity);
  ...
  private void insertFailedBook(BookEntity bookEntity) {
  ...
  private boolean handle(BookEntity iter) throws Exception {
